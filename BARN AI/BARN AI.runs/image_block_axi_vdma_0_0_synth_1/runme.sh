...
HD_PWD='C:/Users/user/Desktop/project/FPGA/BARN AI/BARN AI.runs/image_block_axi_vdma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_block_axi_vdma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_block_axi_vdma_0_0.tcl
