...
HD_PWD='C:/Users/user/Desktop/project/FPGA/BARN AI/BARN AI.runs/image_block_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_block_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_block_rst_ps7_0_100M_0.tcl
