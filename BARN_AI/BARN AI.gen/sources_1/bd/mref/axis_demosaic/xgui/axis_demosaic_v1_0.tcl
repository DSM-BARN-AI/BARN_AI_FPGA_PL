...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BAYER_PHASE" -parent ${Page_0}
...
proc update_PARAM_VALUE.BAYER_PHASE { PARAM_VALUE.BAYER_PHASE } {
	# Procedure called to update BAYER_PHASE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BAYER_PHASE { PARAM_VALUE.BAYER_PHASE } {
	# Procedure called to validate BAYER_PHASE
	return true
}
...
proc update_MODELPARAM_VALUE.BAYER_PHASE { MODELPARAM_VALUE.BAYER_PHASE PARAM_VALUE.BAYER_PHASE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BAYER_PHASE}] ${MODELPARAM_VALUE.BAYER_PHASE}
}
