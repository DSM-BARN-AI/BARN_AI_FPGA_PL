...
//               AI.gen/sources_1/bd/image_block/ip/image_block_axis_vid_mux_0_0/image_block_axis_vid_mux_0_0_stub.v}
...
(* CHECK_LICENSE_TYPE = "image_block_axis_vid_mux_0_0,axis_vid_mux,{}" *) (* CORE_GENERATION_INFO = "image_block_axis_vid_mux_0_0,axis_vid_mux,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=axis_vid_mux,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "axis_vid_mux,Vivado 2025.2" *) 
module image_block_axis_vid_mux_0_0(aclk, aresetn, sel, s0_axis_tdata, 
  s0_axis_tvalid, s0_axis_tready, s0_axis_tuser, s0_axis_tlast, s1_axis_tdata, 
...
/* synthesis syn_black_box black_box_pad_pin="aresetn,sel,s0_axis_tdata[23:0],s0_axis_tvalid,s0_axis_tready,s0_axis_tuser,s0_axis_tlast,s1_axis_tdata[23:0],s1_axis_tvalid,s1_axis_tready,s1_axis_tuser,s1_axis_tlast,m_axis_tdata[23:0],m_axis_tvalid,m_axis_tready,m_axis_tuser,m_axis_tlast" */
