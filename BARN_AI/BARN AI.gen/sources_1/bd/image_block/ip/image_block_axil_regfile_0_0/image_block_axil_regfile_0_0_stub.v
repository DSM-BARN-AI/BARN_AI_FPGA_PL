...
//               AI.gen/sources_1/bd/image_block/ip/image_block_axil_regfile_0_0/image_block_axil_regfile_0_0_stub.v}
...
(* CHECK_LICENSE_TYPE = "image_block_axil_regfile_0_0,axil_regfile,{}" *) (* CORE_GENERATION_INFO = "image_block_axil_regfile_0_0,axil_regfile,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=axil_regfile,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,ADDR_WIDTH=12}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "axil_regfile,Vivado 2025.2" *) 
module image_block_axil_regfile_0_0(aclk, aresetn, s_axil_awaddr, s_axil_awvalid, 
  ...
  s_axil_rresp, s_axil_rvalid, s_axil_rready, tpg_enable, pattern_sel, mux_sel, status_in)
/* synthesis syn_black_box black_box_pad_pin="aresetn,s_axil_awaddr[11:0],s_axil_awvalid,s_axil_awready,s_axil_wdata[31:0],s_axil_wstrb[3:0],s_axil_wvalid,s_axil_wready,s_axil_bresp[1:0],s_axil_bvalid,s_axil_bready,s_axil_araddr[11:0],s_axil_arvalid,s_axil_arready,s_axil_rdata[31:0],s_axil_rresp[1:0],s_axil_rvalid,s_axil_rready,tpg_enable,pattern_sel[1:0],mux_sel,status_in[31:0]" */
