...
--               AI.gen/sources_1/bd/image_block/ip/image_block_u_ze_parse_0/image_block_u_ze_parse_0_stub.vhdl}
...
entity image_block_u_ze_parse_0 is
  ...
  attribute CORE_GENERATION_INFO of image_block_u_ze_parse_0 : entity is "image_block_u_ze_parse_0,ze03_parser,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=ze03_parser,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
...
architecture stub of image_block_u_ze_parse_0 is
  attribute syn_black_box : boolean;
  attribute black_box_pad_pin : string;
  attribute syn_black_box of stub : architecture is true;
  attribute black_box_pad_pin of stub : architecture is "aclk,aresetn,s_data[7:0],s_valid,conc[15:0],gas_type[7:0],unit[7:0],decimals[7:0],\range\[15:0],frame_valid,csum_err";
  ...
  attribute X_CORE_INFO of stub : architecture is "ze03_parser,Vivado 2025.2";
begin
end;
