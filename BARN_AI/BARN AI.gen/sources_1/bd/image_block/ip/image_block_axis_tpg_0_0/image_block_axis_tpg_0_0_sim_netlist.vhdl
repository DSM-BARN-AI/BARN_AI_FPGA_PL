...
--               AI.gen/sources_1/bd/image_block/ip/image_block_axis_tpg_0_0/image_block_axis_tpg_0_0_sim_netlist.vhdl}
...
entity image_block_axis_tpg_0_0_axis_tpg is
  port (
  ...
  attribute ORIG_REF_NAME of image_block_axis_tpg_0_0_axis_tpg : entity is "axis_tpg";
end image_block_axis_tpg_0_0_axis_tpg;

architecture STRUCTURE of image_block_axis_tpg_0_0_axis_tpg is
  signal bar_index : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  signal \NLW_bar_pos_reg[11]_i_5_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_bar_pos_reg[11]_i_5_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \bar_pos[10]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \bar_pos[11]_i_7\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \bar_pos[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \bar_pos[2]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \bar_pos[3]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \bar_pos[4]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \bar_pos[5]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \bar_pos[6]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \bar_pos[7]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \bar_pos[8]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \bar_pos[9]_i_1\ : label is "soft_lutpair17";
  attribute ADDER_THRESHOLD : integer;
  attribute ADDER_THRESHOLD of \bar_pos_reg[11]_i_5\ : label is 35;
...
\bar_index[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => m_axis_tready,
      I3 => \^m_axis_tvalid\,
      I4 => \bar_pos[11]_i_4_n_0\,
      I5 => bar_index(0),
      O => \bar_index[0]_i_1_n_0\
    );
\bar_index[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000009AAAAAAA"
    )
        port map (
      I0 => sel0(1),
      I1 => \bar_pos[11]_i_4_n_0\,
      I2 => load,
      I3 => enable_reg,
      I4 => sel0(0),
      I5 => bar_index(0),
...
\bar_pos[11]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      I0 => \bar_pos[11]_i_6_n_0\,
      I1 => bar_pos(5),
      I2 => bar_pos(4),
      I3 => bar_pos(7),
      I4 => bar_pos(6),
      I5 => \bar_pos[11]_i_7_n_0\,
      O => \bar_pos[11]_i_4_n_0\
    );
...
\bar_pos_reg[11]_i_5\: unisim.vcomponents.CARRY4
     port map (
      CI => \bar_pos_reg[8]_i_2_n_0\,
      CO(3 downto 2) => \NLW_bar_pos_reg[11]_i_5_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \bar_pos_reg[11]_i_5_n_2\,
      CO(0) => \bar_pos_reg[11]_i_5_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_bar_pos_reg[11]_i_5_O_UNCONNECTED\(3),
...
enable_reg_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF2A0000"
    )
        port map (
...
\pattern_reg[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FBBB088800000000"
    )
        port map (
      I0 => sel0(3),
      I1 => enable_reg,
...
\pattern_reg[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FBBB088800000000"
    )
        port map (
...
\pattern_reg[1]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B000"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity image_block_axis_tpg_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    enable : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of image_block_axis_tpg_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of image_block_axis_tpg_0_0 : entity is "image_block_axis_tpg_0_0,axis_tpg,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of image_block_axis_tpg_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of image_block_axis_tpg_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of image_block_axis_tpg_0_0 : entity is "axis_tpg,Vivado 2025.2";
end image_block_axis_tpg_0_0;

architecture STRUCTURE of image_block_axis_tpg_0_0 is
...
begin
inst: entity work.image_block_axis_tpg_0_0_axis_tpg
     port map (
      aclk => aclk,
      aresetn => aresetn,
      enable => enable,
