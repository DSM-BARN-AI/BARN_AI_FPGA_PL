...
--               AI.gen/sources_1/bd/image_block/ip/image_block_u_pm_uart_0/image_block_u_pm_uart_0_sim_netlist.vhdl}
...
entity image_block_u_pm_uart_0_uart_rx is
  port (
  ...
  attribute ORIG_REF_NAME of image_block_u_pm_uart_0_uart_rx : entity is "uart_rx";
end image_block_u_pm_uart_0_uart_rx;

architecture STRUCTURE of image_block_u_pm_uart_0_uart_rx is
...
entity image_block_u_pm_uart_0 is
  ...
  attribute NotValidForBitStream of image_block_u_pm_uart_0 : entity is true;
  ...
  attribute X_CORE_INFO of image_block_u_pm_uart_0 : entity is "uart_rx,Vivado 2025.2";
end image_block_u_pm_uart_0;

architecture STRUCTURE of image_block_u_pm_uart_0 is
...
begin
inst: entity work.image_block_u_pm_uart_0_uart_rx
     port map (
      aclk => aclk,
      aresetn => aresetn,
      frame_err => frame_err,
