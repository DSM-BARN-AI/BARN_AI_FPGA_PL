...
//               AI.gen/sources_1/bd/image_block/ip/image_block_u_pm_uart_0/image_block_u_pm_uart_0_stub.v}
...
(* CHECK_LICENSE_TYPE = "image_block_u_pm_uart_0,uart_rx,{}" *) (* CORE_GENERATION_INFO = "image_block_u_pm_uart_0,uart_rx,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=uart_rx,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,CLK_FREQ_HZ=100000000,BAUD=9600,OVERSAMPLE=16}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "uart_rx,Vivado 2025.2" *) 
module image_block_u_pm_uart_0(aclk, aresetn, rx, m_data, m_valid, frame_err)
