...
//               AI.gen/sources_1/bd/image_block/ip/image_block_axis_wb_0_0/image_block_axis_wb_0_0_stub.v}
...
(* CHECK_LICENSE_TYPE = "image_block_axis_wb_0_0,axis_whitebalance,{}" *) (* CORE_GENERATION_INFO = "image_block_axis_wb_0_0,axis_whitebalance,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=axis_whitebalance,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,GAIN_SHIFT=8,GAIN_MIN=64,GAIN_MAX=1023}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "axis_whitebalance,Vivado 2025.2" *) 
module image_block_axis_wb_0_0(aclk, aresetn, s_axis_tdata, s_axis_tvalid, 
