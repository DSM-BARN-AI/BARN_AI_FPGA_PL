...
//               AI.gen/sources_1/bd/image_block/ip/image_block_axis_tpg_B_0/image_block_axis_tpg_B_0_stub.v}
...
(* CHECK_LICENSE_TYPE = "image_block_axis_tpg_B_0,axis_tpg,{}" *) (* CORE_GENERATION_INFO = "image_block_axis_tpg_B_0,axis_tpg,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=axis_tpg,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,H_ACTIVE=64,V_ACTIVE=48}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "axis_tpg,Vivado 2025.2" *) 
module image_block_axis_tpg_B_0(aclk, aresetn, enable, pattern_sel, m_axis_tdata, 
